          ...
          <div className="antialiased group relative w-full">
            <div className="text-md relative z-40 flex flex-col gap-3 font-semibold tracking-wide text-primary lg:absolute lg:right-0 lg:top-[27%] lg:block lg:max-w-[580px] lg:text-start lg:text-lg xl:top-1/3 xl:h-[442px] xl:max-w-[650px]">
              <div className="flex h-full flex-col justify-center gap-6">
                <span>
                  I’m a passionate Full-Stack Software Engineer dedicated to transforming complex challenges into elegant, scalable solutions. With 3+ years of hands-on experience, I specialize in building high-performance web applications that deliver seamless user experiences and robust functionality.
                </span>
                <span>
                At Dotdash Meredith in Bengaluru, I’ve grown as both a developer and mentor, leading projects that merge creativity with practical innovation. Every day, I’m inspired to design digital experiences that are visually captivating and engineered to perfection.
                </span>
                <p className="flex flex-col items-start sm:items-center lg:items-start">
                  <span>Let’s connect for exciting tech opportunities and collaborations.</span>
